...
public class Game {
    ...
    public void startSecondgame() throws InterruptedException {
        drawPictures.drawSnowGame();
        player.ski.draw();
        drawPictures.drawPine();

        drawPictures.beer3.draw();
        drawPictures.beer4.draw();
        drawPictures.beer5.draw();
        System.out.println("game2");

        while (true) {
            System.out.println("entrei game2");
            int pineous = drawPictures.getPineCode();

            if (pineous == 1 || pineous == 2) {
                System.out.println("mexe a pine1");
                drawPictures.translateDOWN(drawPictures.pine1, 60);
                if ((((drawPictures.pine1.getX() + drawPictures.pine1.getMaxX()) / 2) >= player.ski.getX() && ((drawPictures.pine1.getX() + drawPictures.pine1.getMaxX()) / 2) <= player.ski.getMaxX()) &&
                        (drawPictures.pine1.getMaxY() >= 710)) {
                    System.out.println("mexe a pine2");
                    drawPictures.pine1.delete();
                    drawPictures.drawPine();
                    lifesG2++;
                } else if (drawPictures.pine1.getMaxY() >= 850) {
                    System.out.println("mexe a pine2");
                    drawPictures.pine1.delete();
                    drawPictures.drawPine();
                    counterG2++;
            ...
            } else if (pineous == 3 || pineous == 4 || pineous == 5) {
                System.out.println("mexe a pine2");
                drawPictures.translateDOWN(drawPictures.pine2, 40);
                if ((((drawPictures.pine2.getX() + drawPictures.pine2.getMaxX()) / 2) >= player.ski.getX() && ((drawPictures.pine2.getX() + drawPictures.pine2.getMaxX()) / 2) <= player.ski.getMaxX()) &&
                        (drawPictures.pine2.getMaxY() >= 710)) {
                    System.out.println("mexe a pine2");
                    drawPictures.pine2.delete();
                    drawPictures.drawPine();
                    lifesG2++;
                } else if (drawPictures.pine2.getMaxY() >= 850) {
                    System.out.println("mexe a pine2");
                    drawPictures.pine2.delete();
                    drawPictures.drawPine();
                    counterG2++;
                ...
                System.out.println("mexe a pine2");
                drawPictures.translateDOWN(drawPictures.boulder, 50);
                if ((((drawPictures.boulder.getX() + drawPictures.boulder.getMaxX()) / 2) >= player.ski.getX() && ((drawPictures.boulder.getX() + drawPictures.boulder.getMaxX()) / 2) <= player.ski.getMaxX()) &&
                        (drawPictures.boulder.getMaxY() >= 710)) {
                    System.out.println("mexe a pine2");
                    drawPictures.boulder.delete();
                    drawPictures.drawPine();
                    lifesG2++;
                } else if (drawPictures.boulder.getMaxY() >= 850) {
                    System.out.println("mexe a pine2");
                    drawPictures.boulder.delete();
                    drawPictures.drawPine();
                    counterG2++;
            ...
            if (lifesG2 == 1) {
                drawPictures.beer5.delete();
            } else if (lifesG2 == 2) {
                drawPictures.beer4.delete();
            } else if (lifesG2 == 3) {
                drawPictures.beer3.delete();
                sound.stop();
                drawPictures.gameOver.draw();
                break;
            }
        ...
        drawPictures.secondBackground.delete();
        drawPictures.pine1.delete();
        drawPictures.pine2.delete();
        drawPictures.beer5.delete();
        drawPictures.beer4.delete();
